...
if ( ! function_exists( 'brisko_setup' ) ) :
	...
	function brisko_setup() {
		 ...
		 * If you're building a theme based on brisko, use a find and replace
		 * to change 'brisko' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'brisko', get_template_directory() . '/languages' );
