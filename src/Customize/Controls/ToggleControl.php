...
class ToggleControl extends \WP_Customize_Control
{
    ...
    {
        wp_enqueue_script( 'customizer-toggle-control', Assets::uri( 'js/toggle-button-control.min.js' ), [ 'jquery' ], time(), true );
        wp_enqueue_style( 'css-toggle-buttons', Assets::uri( 'css/toggle-buttons.min.css' ), [], time() );
